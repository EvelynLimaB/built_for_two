...
Gera automaticamente todos os ficheiros .dtl corrigidos para a VN "Flower within my Heart".
"""
...
FILES = {
    "ch1_master.dtl": r"""set {BelleArrived} = false
set {BelleLivingHere} = false
set {PastaBurned} = false

[jump_to_timeline path="res://timelines/ch1_scene1_wakeup.dtl"]
""",

    "ch1_scene1_wakeup.dtl": r"""label start
...
Daisy: Turn the light of the bathroom... Hunf, miserable. How long has it been since I last looked at the mirror? I need to wash my hair, and shave… I’ll deal with my hair later.
...
Belle (smiling): Relax, pretty face, I’m okay! Like I said, I didn’t want to worry you. Mom and pops were being more annoying than usual and I decided I didn’t want to deal with their bullshit anymore. It’s been great!
Daisy (sad): Belle…
...
Daisy (angry): Shut the fuck up! You’ve been homeless for more than a year when you knew you could have just called me and lived with me all this time… Why?
Belle (silent): ...
...
Daisy (interrupting): Let me finish! I have two conditions. First one, is that you clean after yourself, I can already deal with the rest of the housework, just don’t give me more shit. Second one… I kinda can’t afford to feed us both in the way I usually eat so, you’ll have to cook for us both. Agreed?
...
""",
    ...
    "ch1_scene2_night_and_bike.dtl": r"""label start
...
Narrator: My hair feels so fluffy. The way she combed my hair really made me feel like we were kids again. I almost forgot how nice it felt to have her next to me. I missed her so much. These plushies are comfy, but I wish she’d be here with me...
Narrator: Ah... I feel... strange. Why am I so... warm...?
Narrator: I guess I’m just... happy. How ironic, huh. It’s really been a while...
Narrator: Doesn’t matter! It’s better if I just focus on what I’ll have to do now that she’s here. I’ll receive my payment in two days. After that, I’ll carry her to the nearest supermarket. Urgh! My guts ache even just thinking about it. Guess that’s what happens when you’re a lazy bitch that’s afraid of sunlight.
...
""",
    ...
    "ch1_scene3_supermarket.dtl": r"""label start
...
Daisy: Being a ‘smart ass’ is literally my job, the best a high school degree could offer for now. What if instead of being such a brat, you could help me with those damn groceries that being a smart ass pays, huh?
...
""",
    ...
    "ch1_scene4_home_breakdown.dtl": r"""label start
...
Narrator: Ugh… What the fuck am I doing?! I spent so much time missing her and now that she’s here I’m treating her like she’s disposable. She’s probably suffered enough already. I can’t be like them… I need to be different… I need to be better… for her…
...
Narrator: (Some time passes) UGH! I CAN’T FUCKING CONCENTRATE!!! What do I do? What do I do…? Hmm… I guess I can try to… relax a little…
...
""",
    ...
    "ch1_scene5_morning_pasta.dtl": r"""label start
...
Belle: Fine, fine. No more door opening. Who would’ve thought you’d be such a scaredy cat that even sunlight scares you. That explains why you’re so pale now, we used to be the same color, you know!
...
""",
    ...
    "ch1_scene6_abby_chat.dtl": r"""label start
[background path="res://backgrounds/daisy_bedroom.png" fade="1.0"]
leave Belle
join Daisy (neutral) left

Daisy (typing): *tec *tec *tec Mission… tec. Accomplished! Haaaaaaaah… it's done! Finally! I'm free….
Narrator: I want to sleep the whole weekend… Damn, I'm starving… Belle isn't cooking shit. All she does all day is doomscroll and complain. I'm tired… I don't really know what to do. Is she still mad at me for the pasta thing? Ugh… thinking hurts… sometimes I just wish I had a mommy older gf to tell me what to do. She'd probably say to try to distract my mind so I wouldn't be stuck in my own thoughts. Yeah, I should probably play something.
...
Daisy: "Leme guess / Another boymoder you found on grindr?"
...
Daisy: "I think so? I don't know, actually. / The thing is / I think I'm doing something really wrong / I don't know what to do."
Abby: "Girl, breathe. / What could you possibly be doing that would be so wrong?"
Daisy: "I think I might be grooming her…"
Abby: "Woah, woah, woah. / Wait a second, D. What the fuck did you do?"
Daisy: "I don't know! It's just… I think I'm attracted to her…"
Abby: "You? / Attracted to someone? / Weren't you ace aro or something?"
Daisy: "I AM! / I don't know why I'm feeling like this. / I hate it. I hate it so much."
Abby: "Daisy, first of all, how old is she?"
Daisy: "18 / but that's beyond the point."
Abby: "Then you're not grooming her? / You're both grown ass woman."
Daisy: "idk its just / complicated / hm / fuck i feel bad abby"
Abby: "You are NOT like him. / You know that, right?"
Daisy: "But what if I'm making her feel this way? What if she's scared of me?"
Abby: "You forget you are as much of a victim as her, D. / You've both gone through that shit. / If there's someone in the entire world who understands you best, it's her."
Daisy: "I… I did something."
Abby: "Elaborate."
Daisy: "I was stressed with work and couldn't concentrate, so I tried to… / You know… destress"
Abby: "And what happened?"
Daisy: "I started to feel good / too good… / like I could / get there, yk?"
Abby: "Wait, that's good! / ???? / You like / Never there"
Daisy (sobbing): "It felt like last time"
Abby: "oh / poor girl"
Daisy: "I think it's because I felt like she could hear me. / Fuck / I'm monster."
Abby: "D / listen to me / some people deal with shit in different ways okay? / You are NOT a monster / Freaky? / yea. we figured that together b4 / but that's not a bad thing."
Daisy: "I hate that I liked it / I hate that it felt good. / I hate my body."
Abby: "C'mon, D, relax. It's okay. You're not doing anything wrong. / We aren't that different, you know / I'm a monster?"
Daisy: "No?"
Abby: "Yeah, cause in your logic, I 'groom' closeted t-girls so I can fuck their brains out and feel like I'm in control of when it happened while I was one. / Main difference I'm fucking consenting adults"
Daisy: "I don't want to / fuck anyone"
Abby: "D, I know your bottom dysphoria sucks / we already know that it doesn't mean you can't try other options, right?"
Daisy: "What is wrong with me…"
Abby: "Youre a pathetic bottom"
Daisy: "Abs."
Abby: "D, why don't you talk to her?"
Daisy: "NO FUCKING WAY. / ???????"
Abby: "Is that really a bad idea? / Like I said / If there's someone who would understand you, it's her. / You shouldn't be afraid of her, she's your beloved lil sis!"
Daisy: "Don't call her like that…"
Abby: "Oh for fuck's sake / Daisy, you had all Volumes of Onimai. / You've always been into some freaky incest stuff. / I know what you are."
Daisy: "STOP STOP FOR THE LOVE OF GOD STOP TALKING."
Abby: "If you don't want to talk to her, what about you sneaking into her stuff and grabbing a used underwear! / Like those really ass ecchi anime"
Daisy: "Sybau. / I'm blocking you forever. / Die"
Abby: "Just kidding just kidding lmao / I'll have to go now D. / Let's just say my… 'food' / has arrived."
Daisy: "..."
Abby: "And by 'food'I mean… / Lets just say haha"
Daisy: "YEA / I GOT IT"
Abby: "I'm Always here for you, princess. / (except when I'm… eating)."
Daisy: "Fuck off. / I swear. / Im gonna do it this time"
Abby: "I'm not gonna fuck 'off' silly! / I'm going to fuck a really pretty girltwink who wears hoodies 24/7!"
Daisy: "I really can't say that you're a chaser?"
Abby: "Yeah. / now go back to the robot mommy ASMRring in your ear how fat and plumpt you are."
Daisy: "I hate you."
Abby: "S2 / Later lil sis enthusiast~"
Daisy: "… (logs off)"
Narrator: Perhaps… things will get better from now on.
[end_timeline]
""",

    "ch2_scene1_balcony.dtl": r"""label start
[background path="res://backgrounds/balcony_night.png" fade="1.0"]
leave Abby
join Belle (neutral) left

Belle (smoking): What a week, huh…
Narrator: Really hard to sleep on a couch that feels like a trash bag full of fucking needles. How can an apartment so high up be so damn hot? There ain't even a good view from this bitchass house. How can Daisy even live here? I guess she doesn't even care. I bet all she does all day is sit her fat ass on that computer and jerk off to anime girls.
Narrator: No… I guess she doesn't. If she did I would have heard it by now with those paper walls. Maybe she's just a workaholic, huh… she's always been so competent with things. Always an +A student, always a perfect child, always polite, always well-behaved… and then… there was me. All I ever did was ruining her life. And now, here I am leeching off her. Eating her food, sleeping on her couch, shitting on her toilet, smoking on her balcony. All hers. Yet, I'm still here…
Narrator: Why hasn't she kicked me out yet? I don't understand why she's all lovey dovey with me after all I've done. Maybe she does love me… pff nah I doubt it. She probably just pity the shit out of me. She doesn't give a fuck about me, she just doesn't want to feel guilty. Maybe it'd be better if I just jumped from this balcony and spared both of us the trouble…
...
""",
    ...
    "ch2_scene2_tv_confrontation.dtl": r"""label start
[background path="res://backgrounds/daisy_apartment.png" fade="1.0"]
leave Daisy
...
Narrator: (Disassociating) There it is. She's kicking me out. Not even “Mrs. Perfect” could stand me. I guess mom and pops were right when they said I will never amount to anything. I'm just a worthless bitch with a pretty body. That's all I am. I don't know how to be anything else… I may be cursed… cursed to hurt everyone I ever loved. Cursed to destroy every relationship I've built. Cursed to burn every single bridge I've ever crossed… I'm despicable. The only good thing I have is this body. So… If I have to use it to get what I want, then so be it. I'll use it. I'll survive. I just need a couple more days, right? Just a couple more days. A couple more days. A couple more days. A couple more days…

update Daisy center [move_time="0.6"]
Daisy: Look, when I said you could live here, I told you only had to follow some conditions: you'd cook and you'd tidy your things up. Since the pasta thing, you haven't cooked at all. All we've been eating has been pre‑heated food and other junk that I can't afford to keep paying. The living room is also filled with empty snacks, dirty clothes and all sorts of trash. Your trash. You haven't even been taking care of your own hygiene, Belle. You rarely bathe and I've never even seen your toothbrush in the bathroom! I'm just… worried about you, about us. I really want us to work. I'm not blaming you either, I just want to understand you, to help you. I want you to help me help you. Are you… listening to me? Belle…? Belle, what are you doing? Belle…? Belle…?! Belle, stop this… please… Belle… Ah!
...
Narrator: A cheerful man in cleric attire appears on the TV. He's proudly announcing his candidacy while a choir of children sing in the background. He approaches the kids and gives them all a big hug. “We need to protect our children from the common enemy,” he says.
...
""",
    ...
    "ch2_scene3_park_confession.dtl": r"""label start
...
Belle: IT'S MY FAULT!!! HE WASN'T FORCING HIMSELF ONTO ME, I WANTED IT!!! You don't know what it's like… he was the first one to tell me I was special… I… I miss it. I miss… him.
Daisy (wailing): fuck… Belle… I'm so fucking sorry…
Belle: If you hadn't barged in that day… If you hadn't been such a nosy bitch, you… you'd have been fine. No one would have known you were a girl… You'd still have your paid scholarship… You'd still have a bright future ahead of you. But no… no… NO… YOU HAD TO FUCKING HIT HIS HEAD WITH THAT GLASS, HADN'T YOU?! YOU HAD TO LET YOUR WEAK FAT ASS BE RAPED!!! YOU HAD TO MAKE OUR ENTIRE HOMETOWN THINK YOU WERE GROOMING ME!!! YOU DESTROYED YOUR ENTIRE FUTURE AND FOR WHAT?!?! HUH?!?! FOR NOTHING!!! … for nothing…
Daisy (screaming): IT WASN'T FOR NOTHING!!! IT WAS FOR YOU!!! ALL I EVER DID WAS FOR YOU!!! … you weren't just special, you were everything to me. I was in pain for months. I bled every single fucking day. No one believed me… No one… just you… and they took you away from me!!! I missed you so much…
Belle (softening): Day… You're a fucking moron…
Daisy (weary): I know… do you know… what my plan was?
Belle: What plan?
Daisy: After I graduated high‑school, I planned to ask you to live with me. I always wanted us to be together. It wouldn't be easy, for sure, but… I wanted to take you away from our parents. I wanted you to grow up in a household filled with love – not whatever our parents expected from us. That's why I was always trying so hard, you know? I wanted to be good enough… for both of us… so you wouldn't have to suffer anymore.
...
""",
    ...
    "ch2_scene4_hill_assault.dtl": r"""label start
[background path="res://backgrounds/hill_road.png" fade="1.0"]
...
""",
    ...
    "ch2_scene5_dark_thoughts.dtl": r"""label start
[background path="res://backgrounds/daisy_apartment.png" fade="1.0"]
leave Daisy
Belle (alone): ...

Narrator: It's your fault, you know that, right? If you hadn't freaked out earlier, you'd both be nice and cozy. Better yet, if you had never come here in the first place, she wouldn't have to deal with your bullshit. Isabelle, you're a fucking disgrace. I bet you wish she'd just run away and let them have fun with you, don't you? I bet you wish they would teach you a lesson for being such a bad girl, don't you? I bet you wish they'd break you and leave you to bleed at the nearest dumpster, don't you? But no… She saved you once again. A dumb, innocent and weak little bunny that needs to be saved again and again and again. Because she loves you so much, right? She will grow tired of you. It may take a while, but someday, she will notice. She will notice how much of a dead weight you are. And when that day comes… you will be alone. And you know what happens after that? Another wolf will come. It will offer you food and a place to stay. It will give you its time and attention. But then… it will get hungry… it will devour you. Rip your flesh straight out of your bones. Pull your guts out of your belly. Dump your body in a yard full of petals. There's no salvation for you, little bunny. Just await for the time when the Bell tolls for thee. It will come as shortly as the length of your tail. You hear me, Isabelle? Even the air coming in and out of your lungs is wasted on a creature so futile and revolting. Not even your dismembered foot would be a sign of good luck. DO YOU HEAR ME, ISABELLE?! Let's play a game. Walk towards the drawer, grab the sharpest knife you can find. cover yourself head to toe with super sexy scars, right? That's what you want, right? That's what you ever wanted, right? Catch the damned rabbit, Isabelle. C A T C H ! ! !
...
def main():
    ...
    print("Todos os arquivos .dtl foram gerados com sucesso!")
